...
# # Use the read_scores_from_csv function and calculate average score and standard error
# if __name__ == "__main__":
#     scores_df = read_scores_from_csv()
#     print("Best Scores from CSV:")
#     print(scores_df)
...
#     # Calculate average score and standard error
#     average_score, standard_error = calculate_average_and_std_error(scores_df)

#     # Output the calculated average score and standard error
#     print(f"\nAverage Score: {average_score}")
#     print(f"Standard Error: {standard_error}")
